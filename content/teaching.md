...
- **SPH BS 849** — Bayesian Modeling for Biomedical Research & Public Health *(Spring 2026)*
- **SPH BS 807** — Applied Causal Inference in Health Research *(Fall 2024)*

**Wake Forest University** — Department of Mathematics and Statistics

- **STA 111** — Elementary Probability and Statistics *(Fall 2020)*

**Davidson College** — Department of Economics

- **ECO 105** — Statistics and Basic Econometrics *(Spring 2018)*

## Tutor

**Wake Forest University** — Department of Mathematics and Statistics

- Math & Stats Center *(Fall 2020)*
